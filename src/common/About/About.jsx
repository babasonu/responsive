  ...
  return (
    <div className='about'>
        ...
        <div className='about-right '   >
            ...
            <h2>
                Nurturing Tomorrow Leader Today 
            </h2>
            <p> Embark on a transformative educationl journey with our university's comprehensive education programs.
                Our cutting-edge curriculum is designed to empower students with the knowledge, skills, and experience needed to excel
